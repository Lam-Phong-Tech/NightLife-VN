...
const colors = {
  ...
  notificationPanel: "var(--vy-notification-panel-bg)",
  notificationRow: "var(--vy-notification-row-bg)",
  notificationUnread: "var(--vy-notification-unread-bg)",
...
function NoticeRow({
  ...
  const rowStyle: React.CSSProperties = {
    ...
    background: notice.unread ? colors.notificationUnread : colors.notificationRow,
    border: 0,
    borderBottom: `1px solid ${colors.border}`,
    position: "relative",
    width: "100%",
