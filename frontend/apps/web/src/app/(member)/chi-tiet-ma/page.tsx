...
<div style={{"width":"100%","minWidth":"100%","minHeight":"100vh","boxSizing":"border-box","padding":"0px","background":"#e7e5df","fontFamily":"'Inter',sans-serif"}}>
  ...
  <div style={{"width":"100%","background":"#f5f4f2","borderRadius":"0px","overflow":"hidden","boxShadow":"0 12px 40px rgba(0,0,0,.10)","color":"#1f1d29"}}>
    ...
    <div style={{"display":"flex","alignItems":"center","justifyContent":"space-between","padding":"18px 34px","background":"#fff","borderBottom":"1px solid #ececec"}}>
      ...
      <div style={{"display":"flex","alignItems":"center","gap":"14px"}}><Link href="/vi-uu-dai" className="lk" style={{"fontSize":"13px","color":"#6d28d9","fontWeight":"600"}}>Ví của tôi ›</Link><div style={{"fontSize":"13px","color":"#6d28d9","background":"#f1ebff","borderRadius":"20px","padding":"6px 12px","fontWeight":"600"}}>VI · 日本語</div><Link href="/dang-nhap" className="lk" style={{"fontSize":"13px","color":"#5b5870"}}>Đăng nhập</Link><Link href="/dang-ky-doi-tac" style={{"fontSize":"13px","fontWeight":"600","color":"#fff","background":"#6d28d9","borderRadius":"22px","padding":"9px 18px"}}>Đăng ký đối tác</Link></div>
    </div>

    <div style={{"padding":"18px 34px 0","fontSize":"12.5px","color":"#8a879a"}}><Link href="/" className="lk">Trang chủ</Link> › <Link href="/uu-dai" className="lk">Ưu đãi</Link> › <span style={{"color":"#1f1d29"}}>Happy Hour −30%</span></div>
      ...
      <div style={{"width":"460px","background":"#fff","borderRadius":"20px","overflow":"hidden","boxShadow":"0 8px 30px rgba(40,20,60,.12)"}}>
        ...
        <div style={{"padding":"26px 28px 8px","textAlign":"center"}}>
          ...
          <div style={{"marginTop":"14px","display":"flex","gap":"8px","justifyContent":"center","flexWrap":"wrap"}}>
            <span style={{"display":"inline-flex","alignItems":"center","gap":"7px","background":"#f1ebff","color":"#6d28d9","borderRadius":"20px","padding":"8px 14px","fontSize":"12.5px","fontWeight":"600"}}><Image width={100} height={100} src="https://img.icons8.com/ios/100/6D28D9/clock.png" style={{"width":"15px","height":"15px","display":"inline-block"}} alt="" />Còn 6 ngày 22 giờ</span>
        ...
        <div style={{"display":"flex","gap":"10px","padding":"16px 28px 26px"}}>
          <Link href="/vi-uu-dai" className="btn" style={{"flex":"1","background":"#6d28d9","color":"#fff","borderRadius":"11px","padding":"13px","fontWeight":"700","fontSize":"14px","textAlign":"center"}}>Lưu vào ví</Link>
          <span className="btn" style={{"flex":"none","border":"1px solid #e0d6f7","borderRadius":"11px","padding":"13px 18px","fontWeight":"600","fontSize":"14px","color":"#6d28d9","display":"flex","alignItems":"center","gap":"7px"}}><Image width={100} height={100} src="https://img.icons8.com/ios/100/6D28D9/share.png" style={{"width":"16px","height":"16px","display":"inline-block"}} alt="" />Chia sẻ</span>
        </div>
      </div>
    </div>
