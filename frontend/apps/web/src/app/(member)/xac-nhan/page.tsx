...
const tourConfirmCopy: Record<LanguageCode, TourConfirmCopy> = {
  vi: {
    ...
    emailSentPrefix: "Thông tin đặt tour đã được gửi về",
    ...
    qrDescription: "Dùng mã này tại từng điểm dừng trong tour.",
    qrNote: "Mã đặt tour được dùng xuyên suốt hành trình.",
    qrTitle: "Mã tour của bạn",
    reservationCode: "Mã đặt tour",
    statusCancelled: "Đã hủy",
    statusConfirmed: "Đã xác nhận tour",
    statusLabel: "Trạng thái",
    statusPending: "Mới · chờ điều phối tour",
  ...
  en: {
    ...
    emailSentPrefix: "Tour details have been sent to",
    ...
    qrDescription: "Use this code at each stop in the tour.",
    qrNote: "The tour code is used throughout the itinerary.",
    qrTitle: "Your tour code",
    reservationCode: "Tour code",
    statusCancelled: "Cancelled",
    statusConfirmed: "Tour confirmed",
    statusLabel: "Status",
    statusPending: "New · tour coordination pending",
  ...
  ja: {
    ...
    emailSentPrefix: "ツアー予約詳細を送信しました:",
    ...
    qrDescription: "この予約コードをツアーの各立ち寄り先で使用します。",
    qrNote: "ツアー予約コードは行程全体で使用します。",
    qrTitle: "ツアー予約コード",
    reservationCode: "ツアー予約コード",
    statusCancelled: "キャンセル済み",
    statusConfirmed: "ツアー確認済み",
    statusLabel: "ステータス",
    statusPending: "新規 · ツアー調整待ち",
    summaryAria: "ツアー予約概要",
    timeLabel: "時間",
    tourLabel: "ツアー",
    viewMyTour: "ツアー予約を確認",
  ...
  ko: {
    ...
    emailSentPrefix: "투어 예약 정보가 다음 이메일로 전송되었습니다:",
    ...
    qrDescription: "이 예약 코드를 투어의 각 방문 지점에서 사용합니다.",
    qrNote: "투어 예약 코드는 전체 일정에서 사용됩니다.",
    qrTitle: "내 투어 예약 코드",
    reservationCode: "투어 예약 코드",
    statusCancelled: "취소됨",
    statusConfirmed: "투어 확인됨",
    statusLabel: "상태",
    statusPending: "신규 · 투어 조율 대기",
  ...
  zh: {
    ...
    emailSentPrefix: "行程预约详情已发送至",
    guestEmailFallback: "你的邮箱",
    itineraryLabel: "行程路线",
    noCast: "未选择陪伴人员",
    pendingText: "行程预约请求已成功发送。管理员会检查每个停靠点的店铺和陪伴人员。",
    pendingTitle: "行程预约请求已发送",
    qrDescription: "此预约码可在行程的每个停靠点使用。",
    qrNote: "行程预约码将贯穿整个路线使用。",
    qrTitle: "你的行程预约码",
    reservationCode: "行程预约码",
    statusCancelled: "已取消",
    statusConfirmed: "行程已确认",
    statusLabel: "状态",
    statusPending: "新建 · 行程协调中",
    summaryAria: "行程预约摘要",
    timeLabel: "时间",
    tourLabel: "行程",
    viewMyTour: "查看我的行程预约",
...
export default function Page() {
  ...
  const statusText = isTourBooking
    ? isCancelled
      ...
      : isPartnerApproved
        ? translateText("Đã check-in điểm dừng", activeLanguage)
        : isConfirmed
