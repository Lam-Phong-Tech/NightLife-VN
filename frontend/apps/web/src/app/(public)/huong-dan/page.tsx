...
const faqs: FAQItem[] = Array(5).fill({
        ...
        open: () => { window.location.assign('/chi-tiet-quan'); }
      });
...
<div style={{"width":"100%","minHeight":"100vh","boxSizing":"border-box","padding":"0px","background":"#e7e5df","fontFamily":"'Inter',sans-serif"}}>
  <div style={{"margin":"0 auto","width":"100%","background":"#f5f4f2","borderRadius":"0px","overflow":"hidden","boxShadow":"0 12px 40px rgba(0,0,0,.16)","color":"#1f1d29","border":"1px solid #e3e0da"}}>
    ...
    <div style={{"background":"#fff","padding":"8px 18px 14px","display":"flex","alignItems":"center","gap":"12px"}}>
      <Link href="/" style={{"width":"34px","height":"34px","borderRadius":"10px","background":"#f3f2f5","display":"flex","alignItems":"center","justifyContent":"center","flex":"none"}}>
        <Image width={100} height={100} src="https://img.icons8.com/ios/100/1f1d29/left.png" style={{"width":"16px","height":"16px","display":"inline-block"}} alt="" />
      </Link>
      <div>
      ...
      <div style={{"background":"#fff","borderRadius":"14px","padding":"14px","boxShadow":"0 3px 12px rgba(40,20,60,.06)"}}>
        <div style={{"display":"flex","flexDirection":"column","gap":"12px"}}>
          <div style={{"display":"flex","alignItems":"center","gap":"11px"}}>
            <span style={{"width":"38px","height":"38px","borderRadius":"11px","flex":"none","background":"#ede9fe","display":"flex","alignItems":"center","justifyContent":"center"}}><Image width={100} height={100} src="https://img.icons8.com/ios/100/6D28D9/search.png" style={{"width":"18px","height":"18px","display":"inline-block"}} alt="" /></span>
          ...
          <div style={{"display":"flex","alignItems":"center","gap":"11px"}}>
            <span style={{"width":"38px","height":"38px","borderRadius":"11px","flex":"none","background":"#ede9fe","display":"flex","alignItems":"center","justifyContent":"center"}}><Image width={100} height={100} src="https://img.icons8.com/ios/100/6D28D9/calendar.png" style={{"width":"18px","height":"18px","display":"inline-block"}} alt="" /></span>
          ...
          <div style={{"display":"flex","alignItems":"center","gap":"11px"}}>
            <span style={{"width":"38px","height":"38px","borderRadius":"11px","flex":"none","background":"#ede9fe","display":"flex","alignItems":"center","justifyContent":"center"}}><Image width={100} height={100} src="https://img.icons8.com/ios/100/6D28D9/checkmark.png" style={{"width":"18px","height":"18px","display":"inline-block"}} alt="" /></span>
    ...
    <div style={{"padding":"0 18px 4px"}}>
      <div style={{"background":"#fff","borderRadius":"14px","padding":"14px","boxShadow":"0 3px 12px rgba(40,20,60,.06)"}}>
        <div style={{"display":"flex","flexDirection":"column","gap":"12px"}}>
          <div style={{"display":"flex","alignItems":"center","gap":"11px"}}>
            <span style={{"width":"38px","height":"38px","borderRadius":"11px","flex":"none","background":"#fef3eb","display":"flex","alignItems":"center","justifyContent":"center"}}><Image width={100} height={100} src="https://img.icons8.com/ios/100/e8923a/geisha.png" style={{"width":"18px","height":"18px","display":"inline-block"}} alt="" /></span>
          ...
          <div style={{"display":"flex","alignItems":"center","gap":"11px"}}>
            <span style={{"width":"38px","height":"38px","borderRadius":"11px","flex":"none","background":"#fef3eb","display":"flex","alignItems":"center","justifyContent":"center"}}><Image width={100} height={100} src="https://img.icons8.com/ios/100/e8923a/marker.png" style={{"width":"18px","height":"18px","display":"inline-block"}} alt="" /></span>
          ...
          <div style={{"display":"flex","alignItems":"center","gap":"11px"}}>
            <span style={{"width":"38px","height":"38px","borderRadius":"11px","flex":"none","background":"#fef3eb","display":"flex","alignItems":"center","justifyContent":"center"}}><Image width={100} height={100} src="https://img.icons8.com/ios/100/e8923a/appointment-reminders.png" style={{"width":"18px","height":"18px","display":"inline-block"}} alt="" /></span>
        ...
        <div style={{"display":"flex","flexDirection":"column","gap":"8px"}}>
          <div style={{"display":"flex","alignItems":"center","justifyContent":"space-between","padding":"10px 12px","background":"#fdf8f1","borderRadius":"10px","borderLeft":"3px solid #b45309"}}>
            <div style={{"display":"flex","alignItems":"center","gap":"9px"}}>
              <span style={{"width":"28px","height":"28px","borderRadius":"8px","background":"#b45309","display":"flex","alignItems":"center","justifyContent":"center"}}><Image width={100} height={100} src="https://img.icons8.com/ios-filled/100/ffffff/star.png" style={{"width":"14px","height":"14px","display":"inline-block"}} alt="" /></span>
          ...
          <div style={{"display":"flex","alignItems":"center","justifyContent":"space-between","padding":"10px 12px","background":"#f4f5f6","borderRadius":"10px","borderLeft":"3px solid #64748b"}}>
            <div style={{"display":"flex","alignItems":"center","gap":"9px"}}>
              <span style={{"width":"28px","height":"28px","borderRadius":"8px","background":"#64748b","display":"flex","alignItems":"center","justifyContent":"center"}}><Image width={100} height={100} src="https://img.icons8.com/ios-filled/100/ffffff/star.png" style={{"width":"14px","height":"14px","display":"inline-block"}} alt="" /></span>
          ...
          <div style={{"display":"flex","alignItems":"center","justifyContent":"space-between","padding":"10px 12px","background":"#fffbeb","borderRadius":"10px","borderLeft":"3px solid #d97706"}}>
            <div style={{"display":"flex","alignItems":"center","gap":"9px"}}>
              <span style={{"width":"28px","height":"28px","borderRadius":"8px","background":"#d97706","display":"flex","alignItems":"center","justifyContent":"center"}}><Image width={100} height={100} src="https://img.icons8.com/ios-filled/100/ffffff/star.png" style={{"width":"14px","height":"14px","display":"inline-block"}} alt="" /></span>
          ...
          <div style={{"display":"flex","alignItems":"center","justifyContent":"space-between","padding":"10px 12px","background":"linear-gradient(90deg,#f5f1ff,#fce8f8)","borderRadius":"10px","borderLeft":"3px solid #6d28d9"}}>
            <div style={{"display":"flex","alignItems":"center","gap":"9px"}}>
              <span style={{"width":"28px","height":"28px","borderRadius":"8px","background":"#6d28d9","display":"flex","alignItems":"center","justifyContent":"center"}}><Image width={100} height={100} src="https://img.icons8.com/ios-filled/100/ffffff/diamond.png" style={{"width":"14px","height":"14px","display":"inline-block"}} alt="" /></span>
