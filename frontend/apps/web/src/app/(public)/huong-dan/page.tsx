...
export const metadata: Metadata = {
  ...
  description: "Trang hướng dẫn hỗ trợ đang được Vietyoru cập nhật.",
  robots: {
    index: false,
    follow: false,
  },
...
export default function GuideUpdatingPage() {
  return (
    <SystemStatusPage
      ...
      contextDescription="Trang hướng dẫn hỗ trợ đang được hoàn thiện. Bạn có thể quay về trang chủ hoặc tiếp tục tìm quán, cast và ưu đãi trong lúc chờ cập nhật."
      primaryHref="/"
