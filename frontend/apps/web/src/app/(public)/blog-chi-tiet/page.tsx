  ...
  <div style={{"margin":"0 auto","width":"100%","background":"#f5f4f2","borderRadius":"0px","overflow":"hidden","boxShadow":"0 12px 40px rgba(0,0,0,.16)","color":"#1f1d29","border":"1px solid #e3e0da"}}>
    ...
    <div style={{"padding":"6px 18px 18px"}}>
      ...
      <div style={{"marginTop":"11px","display":"flex","flexDirection":"column","gap":"11px"}}>
        <Link href="/blog-chi-tiet" style={{"display":"flex","gap":"11px","alignItems":"center","background":"#fff","border":"1px solid #ececec","borderRadius":"12px","padding":"9px"}}><span style={{"width":"54px","height":"54px","borderRadius":"10px","flex":"none","background":"url('https://images.unsplash.com/photo-1572116469696-31de0f17cc34?auto=format&fit=crop&w=200&q=70') center/cover,linear-gradient(140deg,#d6336c,#7b2d6b)"}}></span><div style={{"flex":"1","minWidth":"0"}}><div style={{"fontSize":"12.5px","fontWeight":"600","lineHeight":"1.35"}}>Văn hoá karaoke Nhật tại Hà Nội</div><div style={{"fontSize":"10.5px","color":"#8a879a","marginTop":"3px"}}>20/06 · 7 phút đọc</div></div></Link>
        <Link href="/blog-chi-tiet" style={{"display":"flex","gap":"11px","alignItems":"center","background":"#fff","border":"1px solid #ececec","borderRadius":"12px","padding":"9px"}}><span style={{"width":"54px","height":"54px","borderRadius":"10px","flex":"none","background":"url('https://images.unsplash.com/photo-1551024601-bec78aea704b?auto=format&fit=crop&w=200&q=70') center/cover,linear-gradient(140deg,#8a6ad0,#5d3da8)"}}></span><div style={{"flex":"1","minWidth":"0"}}><div style={{"fontSize":"12.5px","fontWeight":"600","lineHeight":"1.35"}}>Bản đồ Quận 1 về đêm cho khách Nhật</div><div style={{"fontSize":"10.5px","color":"#8a879a","marginTop":"3px"}}>19/06 · 6 phút đọc</div></div></Link>
        <Link href="/blog-chi-tiet" style={{"display":"flex","gap":"11px","alignItems":"center","background":"#fff","border":"1px solid #ececec","borderRadius":"12px","padding":"9px"}}><span style={{"width":"54px","height":"54px","borderRadius":"10px","flex":"none","background":"url('https://images.unsplash.com/photo-1596838132731-3301c3fd4317?auto=format&fit=crop&w=200&q=70') center/cover,linear-gradient(140deg,#e0a23a,#c0782d)"}}></span><div style={{"flex":"1","minWidth":"0"}}><div style={{"fontSize":"12.5px","fontWeight":"600","lineHeight":"1.35"}}>5 mẹo đặt bàn nhanh cuối tuần</div><div style={{"fontSize":"10.5px","color":"#8a879a","marginTop":"3px"}}>16/06 · 4 phút đọc</div></div></Link>
      </div>
    </div>
...
<div style={{"width":"100%","minWidth":"100%","minHeight":"100vh","boxSizing":"border-box","padding":"0px","background":"#e7e5df","fontFamily":"'Inter',sans-serif"}}>
  ...
  <div style={{"width":"100%","background":"#f5f4f2","borderRadius":"0px","overflow":"hidden","boxShadow":"0 12px 40px rgba(0,0,0,.10)","color":"#1f1d29"}}>
    ...
    <div style={{"padding":"18px 34px 0","fontSize":"12.5px","color":"#8a879a"}}><Link href="/" className="lk">Trang chủ</Link> › <Link href="/blog" className="lk">Blog</Link> › <span style={{"color":"#1f1d29"}}>Cẩm nang khu vực</span></div>
    ...
    <div style={{"display":"flex","gap":"28px","padding":"18px 34px 32px"}}>
      ...
      <div style={{"flex":"1"}}>
        ...
        <div style={{"marginTop":"24px","background":"#faf7ff","border":"1px solid #ece4fb","borderRadius":"14px","padding":"16px 18px","display":"flex","alignItems":"center","gap":"13px"}}><Image width={100} height={100} src="/icons/huong-dan-lay-ma.svg" style={{"width":"28px","height":"28px","flex":"none","display":"inline-block"}} alt="" /><div style={{"fontSize":"13px","color":"#5b5870","lineHeight":"1.6"}}>Mẹo: đăng nhập hội viên để nhận giảm tới 10% và tích điểm cho mỗi hóa đơn — xem ngay <Link href="/uu-dai" style={{"color":"#6d28d9","fontWeight":"600"}}>trang Ưu đãi</Link>.</div></div>
      </div>
      ...
      <div style={{"width":"300px","flex":"none","display":"flex","flexDirection":"column","gap":"16px"}}>
        <div style={{"background":"#fff","border":"1px solid #ececec","borderRadius":"16px","padding":"18px","flex":"1"}}>
          ...
          <div style={{"display":"flex","flexDirection":"column","gap":"14px"}}>
            <Link href="/blog-chi-tiet" className="related" style={{"display":"flex","gap":"11px","alignItems":"center"}}><span style={{"width":"54px","height":"54px","borderRadius":"10px","flex":"none","background":"url('https://images.unsplash.com/photo-1572116469696-31de0f17cc34?auto=format&fit=crop&w=200&q=70') center/cover,linear-gradient(140deg,#d6336c,#7b2d6b)"}}></span><div className="rt" style={{"fontSize":"13px","fontWeight":"600","lineHeight":"1.35","transition":"color .14s"}}>Văn hoá karaoke Nhật tại Hà Nội</div></Link>
            <Link href="/blog-chi-tiet" className="related" style={{"display":"flex","gap":"11px","alignItems":"center"}}><span style={{"width":"54px","height":"54px","borderRadius":"10px","flex":"none","background":"url('https://images.unsplash.com/photo-1551024601-bec78aea704b?auto=format&fit=crop&w=200&q=70') center/cover,linear-gradient(140deg,#8a6ad0,#5d3da8)"}}></span><div className="rt" style={{"fontSize":"13px","fontWeight":"600","lineHeight":"1.35","transition":"color .14s"}}>Bản đồ Quận 1 về đêm cho khách Nhật</div></Link>
            <Link href="/blog-chi-tiet" className="related" style={{"display":"flex","gap":"11px","alignItems":"center"}}><span style={{"width":"54px","height":"54px","borderRadius":"10px","flex":"none","background":"url('https://images.unsplash.com/photo-1596838132731-3301c3fd4317?auto=format&fit=crop&w=200&q=70') center/cover,linear-gradient(140deg,#e0a23a,#c0782d)"}}></span><div className="rt" style={{"fontSize":"13px","fontWeight":"600","lineHeight":"1.35","transition":"color .14s"}}>5 mẹo đặt bàn nhanh cuối tuần</div></Link>
            <Link href="/blog-chi-tiet" className="related" style={{"display":"flex","gap":"11px","alignItems":"center"}}><span style={{"width":"54px","height":"54px","borderRadius":"10px","flex":"none","background":"url('https://images.unsplash.com/photo-1514933651103-005eec06c04b?auto=format&fit=crop&w=200&q=70') center/cover,linear-gradient(140deg,#3a8fb0,#2d5fae)"}}></span><div className="rt" style={{"fontSize":"13px","fontWeight":"600","lineHeight":"1.35","transition":"color .14s"}}>Top 10 Lounge sang trọng tại Hà Nội</div></Link>
            <Link href="/blog-chi-tiet" className="related" style={{"display":"flex","gap":"11px","alignItems":"center"}}><span style={{"width":"54px","height":"54px","borderRadius":"10px","flex":"none","background":"url('https://images.unsplash.com/photo-1566417713940-fe7c737a9ef2?auto=format&fit=crop&w=200&q=70') center/cover,linear-gradient(140deg,#c0246a,#fce4ef)"}}></span><div className="rt" style={{"fontSize":"13px","fontWeight":"600","lineHeight":"1.35","transition":"color .14s"}}>Review Club Lumière chi tiết</div></Link>
            <Link href="/blog-chi-tiet" className="related" style={{"display":"flex","gap":"11px","alignItems":"center"}}><span style={{"width":"54px","height":"54px","borderRadius":"10px","flex":"none","background":"url('https://images.unsplash.com/photo-1542314831-c6a4d14eff40?auto=format&fit=crop&w=200&q=70') center/cover,linear-gradient(140deg,#b06a00,#fdefd6)"}}></span><div className="rt" style={{"fontSize":"13px","fontWeight":"600","lineHeight":"1.35","transition":"color .14s"}}>Cách nhận biết quán pub chuẩn gu Nhật</div></Link>
            <Link href="/blog-chi-tiet" className="related" style={{"display":"flex","gap":"11px","alignItems":"center"}}><span style={{"width":"54px","height":"54px","borderRadius":"10px","flex":"none","background":"url('https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&w=200&q=70') center/cover,linear-gradient(140deg,#6d28d9,#3a1f6e)"}}></span><div className="rt" style={{"fontSize":"13px","fontWeight":"600","lineHeight":"1.35","transition":"color .14s"}}>Trải nghiệm văn hoá Izakaya về đêm</div></Link>
          </div>
        </div>
