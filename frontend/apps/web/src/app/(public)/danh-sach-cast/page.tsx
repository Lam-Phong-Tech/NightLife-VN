...
export default function Page() {
  ...
  }, [area, category, city, hasActiveCoupon, query, sort]);
...
function CastDiscoveryCard({ cast }: { cast: PublicCast }) {
  const areaLabel = [
    ...
    .join(" · ");
  const langText =
    cast.languages.map((item) => languageLabels[item] ?? item.toUpperCase()).join(" · ") || "VI";
