...
<div style={{"width":"100%","minHeight":"100vh","boxSizing":"border-box","padding":"0px","background":"#e7e5df","fontFamily":"'Inter',sans-serif"}}>
  <div style={{"margin":"0 auto","width":"100%","background":"#f5f4f2","borderRadius":"0px","overflow":"hidden","boxShadow":"0 12px 40px rgba(0,0,0,.16)","color":"#1f1d29","border":"1px solid #e3e0da"}}>
    <div style={{"background":"#fff","padding":"8px 18px 10px","display":"flex","alignItems":"center","gap":"12px"}}><a href="blog.html" style={{"fontSize":"22px","color":"#5b5870","lineHeight":"1"}}>‹</a><span style={{"fontWeight":"700","fontSize":"14px","color":"#8a879a"}}>Blog</span></div>
...
<div style={{"width":"100%","minWidth":"100%","minHeight":"100vh","boxSizing":"border-box","padding":"0px","background":"#e7e5df","fontFamily":"'Inter',sans-serif"}}>
  ...
  <div style={{"width":"100%","background":"#f5f4f2","borderRadius":"0px","overflow":"hidden","boxShadow":"0 12px 40px rgba(0,0,0,.10)","color":"#1f1d29"}}>
    ...
    <div style={{"padding":"18px 34px 0","fontSize":"12.5px","color":"#8a879a"}}><a href="trang-chu.html" className="lk">Trang chủ</a> › <a href="blog.html" className="lk">Blog</a> › <span style={{"color":"#1f1d29"}}>Cẩm nang khu vực</span></div>
    ...
    <div style={{"display":"flex","gap":"28px","padding":"18px 34px 32px"}}>
      ...
      <div style={{"flex":"1"}}>
        ...
        <div style={{"height":"320px","borderRadius":"16px","background":"url('https://images.unsplash.com/photo-1572116469696-31de0f17cc34?auto=format&fit=crop&w=720&q=70') center/cover,linear-gradient(140deg,#7b2d6b,#3a1f6e)","marginTop":"18px"}}></div>
        ...
        <div style={{"marginTop":"24px","background":"#faf7ff","border":"1px solid #ece4fb","borderRadius":"14px","padding":"16px 18px","display":"flex","alignItems":"center","gap":"13px"}}><img src="https://img.icons8.com/fluency/96/idea.png" style={{"width":"28px","height":"28px","flex":"none"}} alt="" /><div style={{"fontSize":"13px","color":"#5b5870","lineHeight":"1.6"}}>Mẹo: đăng nhập hội viên để nhận giảm tới 10% và tích điểm cho mỗi hóa đơn — xem ngay <a href="uu-dai.html" style={{"color":"#6d28d9","fontWeight":"600"}}>trang Ưu đãi</a>.</div></div>
      </div>

      {/* SIDEBAR */}
      <div style={{"width":"300px","flex":"none","display":"flex","flexDirection":"column","gap":"16px"}}>
        <div style={{"background":"#fff","border":"1px solid #ececec","borderRadius":"16px","padding":"18px","position":"sticky","top":"20px"}}>
          <div style={{"fontWeight":"700","fontSize":"15px","marginBottom":"12px"}}>Bài liên quan</div>
          <div style={{"display":"flex","flexDirection":"column","gap":"14px"}}>
            <a href="blog-chi-tiet.html" className="related" style={{"display":"flex","gap":"11px","alignItems":"center"}}><span style={{"width":"54px","height":"54px","borderRadius":"10px","flex":"none","background":"url('https://images.unsplash.com/photo-1572116469696-31de0f17cc34?auto=format&fit=crop&w=200&q=70') center/cover,linear-gradient(140deg,#d6336c,#7b2d6b)"}}></span><div className="rt" style={{"fontSize":"13px","fontWeight":"600","lineHeight":"1.35","transition":"color .14s"}}>Văn hoá karaoke Nhật tại Hà Nội</div></a>
            <a href="blog-chi-tiet.html" className="related" style={{"display":"flex","gap":"11px","alignItems":"center"}}><span style={{"width":"54px","height":"54px","borderRadius":"10px","flex":"none","background":"url('https://images.unsplash.com/photo-1551024601-bec78aea704b?auto=format&fit=crop&w=200&q=70') center/cover,linear-gradient(140deg,#8a6ad0,#5d3da8)"}}></span><div className="rt" style={{"fontSize":"13px","fontWeight":"600","lineHeight":"1.35","transition":"color .14s"}}>Bản đồ Quận 1 về đêm cho khách Nhật</div></a>
            <a href="blog-chi-tiet.html" className="related" style={{"display":"flex","gap":"11px","alignItems":"center"}}><span style={{"width":"54px","height":"54px","borderRadius":"10px","flex":"none","background":"url('https://images.unsplash.com/photo-1596838132731-3301c3fd4317?auto=format&fit=crop&w=200&q=70') center/cover,linear-gradient(140deg,#e0a23a,#c0782d)"}}></span><div className="rt" style={{"fontSize":"13px","fontWeight":"600","lineHeight":"1.35","transition":"color .14s"}}>5 mẹo đặt bàn nhanh cuối tuần</div></a>
          </div>
        </div>

        <a href="chi-tiet-quan.html" className="card" style={{"borderRadius":"16px","overflow":"hidden","background":"url('https://images.unsplash.com/photo-1514933651103-005eec06c04b?auto=format&fit=crop&w=720&q=70') center/cover,linear-gradient(140deg,#6d28d9,#3a1f6e)","padding":"22px","color":"#fff","display":"block"}}><div style={{"fontSize":"11px","letterSpacing":".14em","textTransform":"uppercase","color":"#d9c9f7","fontWeight":"700"}}>Quảng cáo</div><div style={{"fontSize":"18px","fontWeight":"800","marginTop":"8px","lineHeight":"1.25"}}>Club Lumière — ưu đãi −30% cuối tuần</div><div className="btn" style={{"marginTop":"14px","background":"#fff","color":"#6d28d9","textAlign":"center","borderRadius":"10px","padding":"11px","fontWeight":"700","fontSize":"13px"}}>Xem ngay</div></a>
      </div>
    </div>
  </div>
</div>
