...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const getPageInfo = () => {
    ...
    if (pathname === '/admin/partners') return { title: 'Duyệt đối tác', subtitle: '' };
      ...
      <div className="nl-admin-main" style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column' }}>
        ...
        <header className="nl-admin-topbar" style={{ position: 'sticky', top: 0, zIndex: 20, display: 'flex', alignItems: 'center', gap: '18px', padding: '14px 26px', background: 'rgba(12,12,15,.86)', backdropFilter: 'blur(12px)', borderBottom: '1px solid rgba(255,255,255,.06)' }}>
          ...
          {!hideTopbarFilters && <div className="nl-admin-topbar-controls">
            {pathname !== '/admin/permissions' && pathname !== '/admin/ranking' && pathname !== '/admin/support-chat' && pathname !== '/admin/coupons' && pathname !== '/admin/bills' && pathname !== '/admin/appearance' && pathname !== '/admin/tours' && (
              <React.Suspense fallback={<div />}>
                <TopCategoryFilter />
              </React.Suspense>
            )}

            {pathname !== '/admin/permissions' && pathname !== '/admin/support-chat' && pathname !== '/admin/coupons' && pathname !== '/admin/bills' && pathname !== '/admin/appearance' && pathname !== '/admin/tours' && (
              <React.Suspense fallback={<div />}>
                <TopRegionFilter />
              </React.Suspense>
            )}
