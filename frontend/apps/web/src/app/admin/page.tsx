...
function AdminDashboardContent() {
  ...
  const city =
    rawCity === "Hanoi" || rawCity === "Ho Chi Minh City" || rawCity === "all" ? rawCity : "all";
  ...
  const loadStats = async () => {
    ...
    try {
      ...
      const data = await apiClient<AdminDashboardStats>(
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      a.href = downloadUrl;
      a.download =
        serverFilename || `bao_cao_nightlife_${tf}_${new Date().toISOString().slice(0, 10)}.xlsx`;
      document.body.appendChild(a);
      a.click();
      a.remove();
      window.setTimeout(() => window.URL.revokeObjectURL(downloadUrl), 1000);
      feedback.showToast({
        title: "Đã tạo báo cáo Excel",
        description: "File gồm Tổng quan, Booking, Hóa đơn và hiệu suất theo quán.",
        tone: "success",
      });
    } catch (err) {
  ...
  return (
    <div
      className="nl-admin-page nl-admin-dashboard"
    ...
    >
      {["SUPER_ADMIN", "ADMIN", "STAFF"].includes(user?.role) &&
        ...
        storageUsage.percentage >= 90 && (
          <div
            style={{
              background: storageUsage.isExceeded
                ? "rgba(244, 67, 54, 0.1)"
                : "rgba(255, 152, 0, 0.1)",
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              stroke={storageUsage.isExceeded ? "#f44336" : "#ff9800"}
              strokeWidth="2"
              strokeLinecap="round"
            ...
            <div>
              <div
                style={{
                  color: storageUsage.isExceeded ? "#f44336" : "#ff9800",
                  fontWeight: 600,
                  fontSize: "15px",
                }}
              >
                {storageUsage.isExceeded
                  ? "Cảnh báo: Dung lượng VPS đã đầy!"
                  : "Cảnh báo: Dung lượng VPS sắp đầy!"}
              </div>
              <div style={{ color: "#c5c0b6", fontSize: "13px", marginTop: "2px" }}>
                ...
                {storageUsage.isExceeded
                  ? " Chức năng upload đã bị khóa tạm thời. Vui lòng dọn dẹp dữ liệu hoặc nâng cấp VPS."
                  : " Hãy kiểm tra và lên kế hoạch nâng cấp dung lượng VPS."}
              </div>
            </div>
          </div>
        )}
      ...
      {/* welcome + range */}
      <div
        className="nl-admin-dashboard-head"
        style={{
          display: "flex",
          alignItems: "flex-end",
      ...
      >
        <div>
          ...
          <div style={{ fontSize: "13px", color: "#8c8679", marginTop: "4px" }}>
            ...
            <b style={{ color: "#e3c27e" }}>{pendingPartners} đối tác</b> đang chờ bạn xử lý.
          </div>
        </div>
        <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
          ...
          <button
            ...
            title="Xuất file Excel gồm tổng quan, booking, hóa đơn và hiệu suất theo quán"
            style={{
              display: "flex",
              alignItems: "center",
              gap: "8px",
        ...
        <>
          ...
          >
            ...
            >
              ...
              <div className="nl-admin-stat-card-title" style={{ fontSize: "11.5px", color: "#c5c0b6", fontWeight: 700, marginTop: "1px" }}>
                Quán hoạt động
              </div>
              <div className="nl-admin-stat-card-subtext" style={{ fontSize: "10.5px", color: "#a8a296", fontWeight: 700, marginTop: "6px" }}>
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: "11px", color: "#e7b869", fontWeight: 600 }}>
                  {pendingCasts} chờ
                </span>
              </div>
              <div
              ...
              <div className="nl-admin-stat-card-title" style={{ fontSize: "11.5px", color: "#c5c0b6", fontWeight: 700, marginTop: "1px" }}>Cast</div>
              <div className="nl-admin-stat-card-subtext" style={{ fontSize: "10.5px", color: "#a8a296", fontWeight: 700, marginTop: "6px" }}>
              ...
              >
                <span
                  style={{
                    ...
                    border: "1px solid rgba(111,159,216,.25)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    color: "#8fb6e4",
                ...
                <span style={{ fontSize: "11px", color: "#7fd3a2", fontWeight: 600 }}>
                  +{todaysBookingsNew} mới
                </span>
              </div>
              <div
                style={{
            ...
            <div
              style={{
                ...
                border: "1px solid rgba(224,164,78,.28)",
                borderRadius: "16px",
                padding: "16px",
              }}
            >
              ...
              >
                <span
                  style={{
                    ...
                    height: "38px",
                    borderRadius: "11px",
                    background: "rgba(224,164,78,.14)",
                    border: "1px solid rgba(224,164,78,.3)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    color: "#e7b869",
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <path d="M3.5 20a5.5 5.5 0 0 1 10.5-2.3M17 8v6M20 11h-6" />
                  </svg>
                </span>
                <span
                  style={{
          ...
          {/* two columns */}
          <div
            className="nl-admin-dashboard-grid"
            style={{
              display: "grid",
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
              ...
              >
                ...
                >
                  <span style={{ fontSize: "16px", fontWeight: 600, color: "#f3f0ea" }}>
                    Cần xử lý ngay
                  </span>
                  <span
                    style={{
                      flex: 1,
                      height: "1px",
                      background: "linear-gradient(90deg,rgba(212,178,106,.4),transparent)",
                    }}
                  ></span>
                </div>
                <div
                  className="nl-admin-action-grid"
                ...
                >
                  <Link
                    ...
                    style={{
                      textDecoration: "none",
                      background: "rgba(224,164,78,.07)",
                      border: "1px solid rgba(224,164,78,.24)",
                      borderRadius: "14px",
                      padding: "14px",
                      cursor: "pointer",
                      display: "block",
                  ...
                  >
                    <div style={{ fontSize: "24px", fontWeight: 800, color: "#e7b869" }}>
                      {pendingBills}
                    </div>
                    <div
                      style={{
                  ...
                  >
                    <div style={{ fontSize: "24px", fontWeight: 800, color: "#f3f0ea" }}>
                      {pendingCasts}
                    </div>
                    <div
                      style={{
                  ...
                  <Link
                    ...
                    style={{
                      textDecoration: "none",
                      background: "rgba(224,114,158,.06)",
                      border: "1px solid rgba(224,114,158,.22)",
                      borderRadius: "14px",
                      padding: "14px",
                      cursor: "pointer",
                      display: "block",
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  {stats?.recentBookings?.map((b, idx, arr) => {
                    ...
                    if (b.status === "COMPLETED") {
                      statusColor = "#7fd3a2";
                      statusBg = "rgba(95,191,134,.1)";
                      statusBorder = "rgba(95,191,134,.28)";
                      statusText = "Hoàn tất";
                    } else if (b.status === "CANCELLED") {
                      statusColor = "#e88b99";
                      statusBg = "rgba(224,105,122,.1)";
                      statusBorder = "rgba(224,105,122,.28)";
                      statusText = "Đã hủy";
                    }

                    return (
                      <div
                        className="nl-admin-recent-row"
                        key={b.id}
                        style={{
                          display: "grid",
                          gridTemplateColumns: "1.4fr 1.4fr .7fr 1fr",
                      ...
                      >
                        ...
                        <div style={{ color: "#8c8679", fontSize: "12px" }}>
                ...
                >
                  <span
                    style={{
                      ...
                      borderRadius: "50%",
                      background: "#e0729e",
                      boxShadow: "0 0 8px #e0729e",
                      animation: "vpulse 1.8s infinite",
                    }}
                  ></span>
                      ...
                      >
                        ...
                        <div style={{ flex: 1 }}>
                          <div style={{ fontSize: "12.5px", color: "#e6e2da", lineHeight: 1.4 }}>
                            {log.templateKey === "telegram.admin.booking.created.v1" ? (
                              <>
                                Booking mới{" "}
                                <b style={{ color: "#fff" }}>
                                  #BK-{(log.booking?.id || log.id).slice(0, 4).toUpperCase()}
                                </b>{" "}
                                — {log.booking?.store?.name || "Hệ thống"} ·{" "}
                                {log.booking?.partySize || 1} khách
                              </>
                            ) : log.templateKey === "telegram.admin.bill.submitted.v1" ? (
                              <>
                                Hóa đơn mới{" "}
                                <b style={{ color: "#fff" }}>
                                  #BILL-{(log.bill?.id || log.id).slice(0, 4).toUpperCase()}
                                </b>{" "}
                                chờ duyệt — {(log.bill?.totalVnd || 0).toLocaleString("vi-VN")}₫
                              </>
                            ) : log.templateKey === "telegram.admin.partner.requested.v1" ? (
                              <>
                                Yêu cầu hợp tác mới —{" "}
                                <b style={{ color: "#fff" }}>
                                  {log.partnerRequest?.businessName || "Đối tác"}
                                </b>{" "}
                                {log.partnerRequest?.storeCity
                                  ? `(${log.partnerRequest.storeCity})`
                                  : ""}
                              </>
                            ) : (
                          ...
                          <div className="nl-admin-telegram-subtext" style={{ fontSize: "10.5px", color: "#a8a296", fontWeight: 700, marginTop: "3px" }}>
                            {timeAgo} ·{" "}
                  ...
                  {chartData.map((d, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        ></span>
                        <span style={{ fontSize: "9.5px", color: labelColor, fontWeight: fw }}>
                          {d.date}
                        </span>
                      </div>
                    );
