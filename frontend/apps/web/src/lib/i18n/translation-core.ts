...
const entries: TranslationEntry[] = [
  ...
  {
    vi: "Tài khoản vừa được đăng nhập trên thiết bị khác",
    en: "Your account was just signed in on another device",
    ja: "アカウントが別のデバイスでログインされました",
    ko: "다른 기기에서 계정에 로그인되었습니다",
    zh: "您的账号刚刚在另一台设备上登录",
  },
  {
    vi: "Tài khoản của bạn vừa đăng nhập trên một thiết bị khác. Phiên làm việc trên thiết bị này đã bị đăng xuất. Nếu không phải bạn thực hiện, vui lòng đổi mật khẩu ngay.",
    en: "Your account was just signed in on another device. This device has been signed out. If this was not you, please change your password immediately.",
    ja: "アカウントが別のデバイスでログインされたため、このデバイスはログアウトされました。心当たりがない場合は、すぐにパスワードを変更してください。",
    ko: "다른 기기에서 계정에 로그인되어 이 기기는 로그아웃되었습니다. 본인이 아닌 경우 즉시 비밀번호를 변경해 주세요.",
    zh: "您的账号刚刚在另一台设备上登录，此设备已被登出。如果不是您本人操作，请立即修改密码。",
  },
  {
    vi: "Đăng nhập này đã đăng xuất một thiết bị khác.",
    en: "This sign-in signed out another device.",
    ja: "このログインにより別のデバイスがログアウトされました。",
    ko: "이번 로그인으로 다른 기기가 로그아웃되었습니다.",
    zh: "本次登录已登出另一台设备。",
  },
  {
    vi: "Đăng nhập lại",
  ...
  {
    vi: "Tìm theo tên cast...",
    en: "Search by Cast name...",
    ja: "キャスト名で検索...",
    ko: "캐스트 이름으로 검색...",
    zh: "按陪伴人员姓名搜索...",
  },
  {
    vi: "Tìm theo tên quán...",
    en: "Search by venue name...",
    ja: "店舗名で検索...",
    ko: "매장 이름으로 검색...",
    zh: "按店铺名称搜索...",
  },
  ...
  {
    vi: "Đang gửi yêu cầu đặt bàn",
    en: "Sending reservation request",
    ja: "予約リクエストを送信中",
    ko: "예약 요청 전송 중",
    zh: "正在发送预约请求",
  },
  ...
  {
    vi: "Đang gửi yêu cầu đặt cast",
    en: "Sending cast reservation request",
    ja: "キャスト予約リクエストを送信中",
    ko: "캐스트 예약 요청 전송 중",
    zh: "正在发送演员预约请求",
  },
  ...
  {
    vi: "Hệ thống đang xử lý, vui lòng chờ trong giây lát.",
    en: "The system is processing, please wait a moment.",
    ja: "システム処理中です。少々お待ちください。",
    ko: "시스템 처리 중입니다. 잠시만 기다려 주세요.",
    zh: "系统正在处理，请稍候。",
  },
  {
    vi: "Yêu cầu đã được ghi nhận, đang chuyển sang trang xác nhận.",
    en: "Request received, redirecting to confirmation page.",
    ja: "リクエストを受け付けました。確認ページへ移動します。",
    ko: "요청이 접수되었습니다. 확인 페이지로 이동합니다.",
    zh: "请求已收到，正在跳转至确认页面。",
  },
  {
    vi: "Yêu cầu tour đã được ghi nhận, đang chuyển sang trang xác nhận.",
    en: "Tour request received, redirecting to confirmation page.",
    ja: "ツアーリクエストを受け付けました。確認ページへ移動します。",
    ko: "투어 요청이 접수되었습니다. 확인 페이지로 이동합니다.",
    zh: "行程请求已收到，正在跳转至确认页面。",
  },
  {
    vi: "Mã đặt chỗ",
    en: "Reservation code",
  ...
  {
    vi: "Sửa tổng tiền",
    en: "Edit total amount",
    ja: "合計金額を編集",
    ko: "총 금액 수정",
    zh: "修改总金额",
  },
  {
    vi: "Vui lòng chụp hoặc chọn ảnh/chứng từ mới để gửi lại hóa đơn.",
    en: "Please take or choose a new photo/document to resubmit the bill.",
    ja: "請求書を再送信するには、新しい写真またはドキュメントを選択してください。",
    ko: "영수증을 다시 제출하려면 새 사진이나 문서를 선택하세요.",
    zh: "请拍摄或选择新的照片/文件以重新提交账单。",
  },
  {
    vi: "Vui lòng điều chỉnh tổng tiền hóa đơn trước khi gửi lại.",
    en: "Please adjust the bill total amount before resubmitting.",
    ja: "再送信する前に請求書の合計金額を調整してください。",
    ko: "다시 제출하기 전에 영수증 총 금액을 수정하세요.",
    zh: "重新提交前请调整账单总金额。",
  },
  {
    vi: "Quán / cơ sở *",
...
const dynamicPhraseEntries: TranslationEntry[] = [
  ...
  {
    vi: "Chọn khu vực video",
    en: "Choose video area",
    ja: "動画のエリアを選択",
    ko: "영상 지역 선택",
    zh: "选择视频区域",
  },
  ...
  {
    vi: "Đang cập nhật banner trang chủ.",
    en: "Updating homepage banners.",
    ja: "ホームページのバナーを更新中です。",
    ko: "홈페이지 배너를 업데이트하고 있습니다.",
    zh: "正在更新首页横幅。",
  },
  {
    vi: "Vi vu hôm nay",
...
function translateDelimitedText(value: string, language: Exclude<LanguageCode, "vi">) {
  ...
  for (const delimiter of delimiters) {
    ...
    const translatedParts = parts.map((part) => translateTextCore(part, language));
...
function translatePattern(value: string, language: Exclude<LanguageCode, "vi">): string | null {
  ...
  if (djNightMatch) {
    const venue = translateTextCore(djNightMatch[1] ?? "", language);
    return {
  ...
  if (maxCharactersMatch) {
    const field = translateTextCore(maxCharactersMatch[1] ?? "", language);
  ...
  if (emptyAreaMatch) {
    const subject = translateTextCore(emptyAreaMatch[1] ?? "", language);
    return {
  ...
  if (tourBookingRequestMatch) {
    ...
    const target = rawTourTarget ? translateTextCore(rawTourTarget, language) : "";
  ...
  if (bookingRecordedMatch) {
    const storeName = translateTextCore(bookingRecordedMatch[1] ?? "", language);
    return {
  ...
  if (bookingRequestWithTimeMatch) {
    const target = translateTextCore(bookingRequestWithTimeMatch[1] ?? "", language);
  ...
  if (bookingRequestMatch) {
    const target = translateTextCore(bookingRequestMatch[1] ?? "", language);
    return {
  ...
  if (billSubmittedMatch) {
    ...
    const storeName = translateTextCore(billSubmittedMatch[2] ?? "", language);
  ...
  if (billVerifiedMatch) {
    ...
    const storeName = translateTextCore(billVerifiedMatch[2] ?? "", language);
  ...
  if (billRejectedMatch) {
    ...
    const storeName = translateTextCore(billRejectedMatch[2] ?? "", language);
  ...
  if (bookingChangedMatch) {
    const target = translateTextCore(bookingChangedMatch[1] ?? "", language);
  ...
  if (bookingRescheduleRejectedMatch) {
    const target = translateTextCore(bookingRescheduleRejectedMatch[1] ?? "", language);
  ...
  if (ownBookingCancelledMatch) {
    const target = translateTextCore(ownBookingCancelledMatch[1] ?? "", language);
  ...
  if (bookingStatusMatch) {
    const target = translateTextCore(bookingStatusMatch[1] ?? "", language);
  ...
  if (bookingGenericUpdateMatch) {
    const target = translateTextCore(bookingGenericUpdateMatch[1] ?? "", language);
    return {
  ...
  if (castAreaMatch) {
    const area = translateTextCore(castAreaMatch[1] ?? "", language);
    return {
      en: `Cast in ${area}`,
      ja: `${area}のキャスト`,
      ko: `${area} Cast`,
  ...
  if (atStoreMatch) {
    const subject = translateTextCore(atStoreMatch[1] ?? "", language);
    const store = translateTextCore(atStoreMatch[2] ?? "", language);
    return {
      en: `${subject} at ${store}`,
      ja: `${store}の${subject}`,
      ko: `${store}의 ${subject}`,
  ...
  if (featuredCategoryMatch) {
    const category = translateTextCore(featuredCategoryMatch[1] ?? "", language);
    return {
  ...
  if (sortWithValueMatch) {
    const sortValue = translateTextCore(sortWithValueMatch[1] ?? "", language);
    return {
      en: `Sort: ${sortValue}`,
      ja: `並び替え: ${sortValue}`,
      ko: `정렬: ${sortValue}`,
  ...
  if (addFavConfirmMatch) {
    const target = translateTextCore(addFavConfirmMatch[1] ?? "", language);
    return {
  ...
  if (removeFavConfirmMatch) {
    const target = translateTextCore(removeFavConfirmMatch[1] ?? "", language);
    return {
  ...
  if (favSavedMatch) {
    const target = translateTextCore(favSavedMatch[1] ?? "", language);
    return {
  ...
  if (favUnsavedMatch) {
    const target = translateTextCore(favUnsavedMatch[1] ?? "", language);
    return {
  ...
  if (actionStatusMatch) {
    ...
    const translatedAction = translateTextCore(rawAction, language);
...
export function translateTextCore(value: string, language: LanguageCode): string {
  if (language === "vi") {
