...
| 4 | PR 4: Activity Core & Redirects | lib/api/partner-portal.ts, usePartnerActivity(), /partner/activity sub-routes, legacy redirects | M3 | DONE (commit c4d80d0a) |
| 5 | PR 5: Home Redesign & Cleanup | Simplify partner/page.tsx into Home Dashboard, monolith cleanup | M4 | IN_PROGRESS |
